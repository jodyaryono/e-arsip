...
<body id="page-top">
    ...
    <div class="col-sm-8 text-left"> 
	  ...
	  <h2>Data Kategori</h2>
         <a href="<?php echo base_url(); ?>kategori/tambah"><button class="btn btn-primary">Tambah data</button></a>
          <table class="table">
            <thead>
              <tr>
                <th>No</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="<?php echo base_url(); ?>kategori/edit/<?php echo $dp['id_kategori']; ?>" title="Ubah"><button class="btn btn-info">Ubah</button></a> 

              <a href="<?php echo base_url(); ?>kategori/hapus/<?php echo $dp['id_kategori']; ?>" onClick="return confirm('Anda yakin..???');" title="Hapus"><button class="btn btn-danger">Hapus</button></a></td>
              </tr>
              <?php
              $no++;
            }
